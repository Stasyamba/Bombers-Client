 ...
 **/
package engine.utils.greensock.loading.core {
import engine.utils.greensock.events.LoaderEvent
import engine.utils.greensock.loading.LoaderMax
import engine.utils.greensock.loading.LoaderStatus
...
[Event(name="open",     type="engine.utils.greensock.events.LoaderEvent")]
/** Dispatched each time the <code>bytesLoaded</code> value changes while loading (indicating progress). **/
[Event(name="progress", type="engine.utils.greensock.events.LoaderEvent")]
/** Dispatched when the loader completes. **/
[Event(name="complete", type="engine.utils.greensock.events.LoaderEvent")]
...
[Event(name="cancel",     type="engine.utils.greensock.events.LoaderEvent")]
/** Dispatched when the loader fails. **/
[Event(name="fail",     type="engine.utils.greensock.events.LoaderEvent")]
/** Dispatched when the loader experiences some type of error, like a SECURITY_ERROR or IO_ERROR. **/
[Event(name="error",     type="engine.utils.greensock.events.LoaderEvent")]
/**
