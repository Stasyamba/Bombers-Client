...
[Event(name="open",     type="greensock.events.LoaderEvent")]
/** Dispatched each time the <code>bytesLoaded</code> value changes while loading (indicating progress). **/
[Event(name="progress", type="greensock.events.LoaderEvent")]
/** Dispatched when the loader completes. **/
[Event(name="complete", type="greensock.events.LoaderEvent")]
...
[Event(name="cancel",     type="greensock.events.LoaderEvent")]
/** Dispatched when the loader fails. **/
[Event(name="fail",     type="greensock.events.LoaderEvent")]
/** Dispatched when the loader experiences some type of error, like a SECURITY_ERROR or IO_ERROR. **/
[Event(name="error",     type="greensock.events.LoaderEvent")]
/**
...
public class LoaderCore extends EventDispatcher {
     ...
     * the actions into a quest function to conserve file size and because many of the same tasks must
