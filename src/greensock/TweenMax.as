 ...
 *     is as simple as activating the plugin with a quest line of code, like <code>TweenPlugin.activate([SetSizePlugin]);</code>
                    ...
                    if (pt.name == prop) {
                        if (pt.isPlugin) {
                            ...
                            if (plugin == null) {
                                ...
                                plugin.add(pt.target, prop, pt.start, pt.change); //using a quest plugin for rounding speeds processing
                            }
